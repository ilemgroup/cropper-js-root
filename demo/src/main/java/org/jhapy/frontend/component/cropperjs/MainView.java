...
public class MainView extends VerticalLayout {
  ...
  public MainView() throws IOException {
    ...
    cropperJs.addCropListener(event -> {
      eventLog.setValue(
          event.toString() + ", isFromClient=" + event.isFromClient() + "\n" + eventLog.getValue());
    });
    ...
    buttonLayoutRow4.add(new Button("Get Data",
        event -> cropperJs.getData(o -> eventLog.setValue((new Gson()).toJson(o)))));
    buttonLayoutRow4.add(new Button("Set Data",
        event -> cropperJs.setData(new Gson().fromJson(eventLog.getValue(), Data.class))));
    buttonLayoutRow4.add(new Button("Get Container Data",
        event -> cropperJs.getContainerData(o -> eventLog.setValue((new Gson()).toJson(o)))));
    buttonLayoutRow4.add(new Button("Get Image Data",
        event -> cropperJs.getImageData(o -> eventLog.setValue((new Gson()).toJson(o)))));
    buttonLayoutRow4.add(new Button("Get Canvas Data",
        event -> cropperJs.getCanvasData(o -> eventLog.setValue((new Gson()).toJson(o)))));
    buttonLayoutRow4.add(new Button("Set Canvas Data", event -> cropperJs
        .setCanvasData(new Gson().fromJson(eventLog.getValue(), SetCanvasDataOptions.class))));
    buttonLayoutRow4.add(new Button("Get Crop Box Data",
        event -> cropperJs.getCropBoxData(o -> eventLog.setValue((new Gson()).toJson(o)))));
    buttonLayoutRow4.add(new Button("Set Crop Box Data", event -> cropperJs
        .setCropBoxData(new Gson().fromJson(eventLog.getValue(), SetCropBoxDataOptions.class))));
